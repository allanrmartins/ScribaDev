...
1. No venv do ScribaDev: `pip install torch --index-url https://download.pytorch.org/whl/cu128` (sem GPU NVIDIA: só `pip install torch`) e depois `pip install pyannote.audio`;
